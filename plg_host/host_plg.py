...
class Agent(agent.Agent):
    def __init__(self, address, ordinal):
        ...
        # midi channel 
        self[7] = atom.Atom(domain=domain.BoundedInt(0,17),init=0,names='midi channel',policy=atom.default_policy(self.set_midi_channel))
        ...
        self.add_verb2(13,'map([],~a,role(None,[matches([channel])]),role(from,[numeric]),role(to,[numeric]))',callback=self.__map_channel_to_midi_channel)
